...
router.get("/", async (req, res) => {
  try {
    ...
    let query = {} // initialisng query object
    // Filter Logic
...
// @descripton Retrieve latest 8 products - Creation date
// @access Public
...
// @desc Get similar product based on the current product's gender and category
// @access Public
